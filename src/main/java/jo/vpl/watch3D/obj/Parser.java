...
public class Parser {
    ...
    public Parser(Model builder, String filename) throws FileNotFoundException, IOException {
    ...
    private void processVertex(String line) {
        ...
        builder.addVertex(values[0], values[1], values[2]);
    }
...
//        builder.addVertexTexture(values[0], values[1]);
    ...
    private void processVertexNormal(String line) {
        ...
        builder.addNormal(values[0], values[1], values[2]);
    }
...
//        System.err.println("Parsed as "+parsedList);
        builder.currentGeometry.addFace(verticeIndexAry);
    }
    ...
    //     line, the data that follows belong to all groups. Geometry information
    //     is optional.
    // 
    ...
    private void processGroupName(String line) {
        ...
        builder.addGeometry(groupnames);
    }
    ...
    private void processSmoothingGroup(String line) {
        ...
        builder.setSmoothingGroup(groupNumber);
    }
    ...
    private void processUseMaterial(String line) {
        builder.currentGeometry.addMaterial(line.substring(OBJ_USEMTL.length()).trim());
    }
    ...
    private void processReflectivityTransmissivity(String fieldName, String line) {
        ...
        if (tokens[0].equals("spectral")) {
            ...
            if (type == 1) {
                builder.currentMaterial.setDiffuseColor(Color.color(r, g, b));
            } else if (type == 2) {
                builder.currentMaterial.setSpecularColor(Color.color(r, g, b));
            }
//            builder.setRGB(type, r, g, b);
    ...
    private void processRefl(String line) {
        ...
        int type = MTL_REFL_TYPE_UNKNOWN;
