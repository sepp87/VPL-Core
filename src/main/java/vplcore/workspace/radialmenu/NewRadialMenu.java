 ...
 */
public class NewRadialMenu extends Group {

    static final double INNER_RADIUS = 50;
    static final double OUTER_RADIUS = 120;

    private final List<NewRadialMenuItem> items;
    private static NewRadialMenu radialMenu;
    ...
    private static NewRadialSubMenu activeRadialSubMenu;
    ...
    public NewRadialMenu(List<NewRadialMenuItem> items) {
        ...
        for (int i = 0; i < count; i++) {
            NewRadialMenuItem item = items.get(i);
            item.index = i;
            item.length = length;
    ...
    public List<NewRadialMenuItem> addSubMenu(NewRadialSubMenu subMenu, List<NewRadialMenuItem> subItems) {
        ...
        for (int i = 0; i < count; i++) {
            NewRadialMenuItem subItem = subItems.get(i);
        ...
        // build exit button
        NewRadialMenuItem exit = new NewRadialMenuItem(subMenu.icon, "Return\nto main");
    ...
    private NewRadialMenuItem addRadialMenuItem(NewRadialMenuItem item, boolean isSubMenu) {
...
//        Label label = new Label(index + "");
    ...
    private EventHandler<MouseEvent> handle_returnToMainClicked = new EventHandler<>() {
        @Override
    ...
    private EventHandler<MouseEvent> handle_openSubMenuClicked = new EventHandler<>() {
        @Override
        public void handle(MouseEvent event) {
            NewRadialSubMenu subMenu = (NewRadialSubMenu) event.getSource();
            openSubMenu(subMenu);
        }
    };

    private void openSubMenu(NewRadialSubMenu subMenu) {
