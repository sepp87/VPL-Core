    ...
    private void createBlock() {
        ...
        if (type.getClass().equals(Class.class)) {
            try {
                ...
                Block block = (Block) cType.getConstructor(Workspace.class).newInstance(workspace);
            ...
            try {
                ...
                ReflectionBlock block = new ReflectionBlock(workspace, info.identifier(), info.category(), info.description(), info.tags(), mType);
