...
public class RadialMenuItemBuilder<B extends RadialMenuItemBuilder<B>> {
    ...
    protected RadialMenuItemBuilder(Enum type) {
        this.item = new RadialMenuItem(type);
    }
    ...
    public static <B extends RadialMenuItemBuilder<B>> RadialMenuItemBuilder<B> create(Enum type) {
        return new RadialMenuItemBuilder<B>(type);
    }
